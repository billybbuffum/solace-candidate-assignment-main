...
const SearchFiltersComponent: React.FC<SearchFiltersProps> = ({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
      ...
      {/* Advanced filters */}
      {showAdvanced && (
        <div id="advanced-filters" className="space-y-4 pt-4 border-t border-gray-200">
          ...
          <div className="flex justify-end pt-4">
            <button
              onClick={handleReset}
              disabled={isLoading}
              className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md disabled:bg-gray-50 disabled:cursor-not-allowed transition-colors duration-200"
            >
              Reset Filters
            </button>
          </div>
